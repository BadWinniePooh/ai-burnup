...
await using (var scope = app.Services.CreateAsyncScope())
{
    ...
    for (int attempt = 1; attempt <= 6; attempt++)
    {
        try
        {
            ...
            // Per-project card and scope type lists
            await db.Database.ExecuteSqlRawAsync(@"
                ALTER TABLE projects ADD COLUMN IF NOT EXISTS ""CardTypes""  text NOT NULL DEFAULT 'feature,bug,no-code,tiny'");
            await db.Database.ExecuteSqlRawAsync(@"
                ALTER TABLE projects ADD COLUMN IF NOT EXISTS ""ScopeTypes"" text NOT NULL DEFAULT 'mvp,mlp,other'");
